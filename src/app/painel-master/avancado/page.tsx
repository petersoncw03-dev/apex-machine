...
export default function RadarAvancado() {
  ...
  const [maxDataHours, setMaxDataHours] = useState(168); // 7 dias completos (168h)
  ...
  }, [deferredScannerData, scanMinKey, scanSortCol, scanSortDir, globalData.length]);
            ...
            <div className="flex flex-col xl:flex-row gap-6 pb-24 items-stretch">
              ...
              {activeTab === 'visao-cores' && (
                <div className="w-full">
                  <VisaoCoresTab globalData={globalData} hideSniper={true} />
                </div>
              )}
