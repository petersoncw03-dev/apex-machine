...
const PLANS = [
  {
    ...
    price: 27,
    priceStr: 'R$ 27',
    description: 'Uma semana completa com todos os radares e ferramentas do Painel Master.',
    recommended: false,
  ...
  },
  {
    ...
    price: 57,
    priceStr: 'R$ 57',
    description: 'O melhor custo-benefício (Apenas R$ 1,90 por dia). Acesso VIP o mês todo.',
    recommended: true,
    features: ALL_FEATURES,
  },
];
